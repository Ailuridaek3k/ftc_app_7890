...
public class FULL_AUTO_RSTONE extends OpMode
{
    ...
    public void init() {
        ...
        ---USING STATES---
         */
        initialMoveState = new ColorSenseStopState(motors, stoneSensorR, "black and yellow", 0.3, "backward");
        stoneState = new doubleColorState(motors, stoneSensorR, stoneSensorL,"black", 0.3, "right");

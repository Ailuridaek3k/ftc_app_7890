...
public class DriveAvoidPIDState implements StateMachine.State {
    ...
    {
        private double m_P;                                 // factor for "proportional" control. Directly related to velocity
        private double m_I;                                 // factor for "integral" control. Directly related to position
        private double m_D;                                 // factor for "derivative" control. Directly related to acceleration
